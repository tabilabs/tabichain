...
1. Either [open](https://github.com/tabilabs/tabichain/issues/new/choose)
   or [find](https://github.com/tabilabs/tabichain/issues) an issue you have identified and would like to contribute to
   resolving.
...
Check out our [good first issues](https://github.com/tabilabs/tabichain/issues?q=label%3A%22good+first+issue%22).

## <span id="adr">Architecture Decision Records (ADR)</span>

When proposing an architecture decision for Tabi,
please create an [ADR](https://github.com/tabilabs/tabichain/blob/main/docs/architecture/README.md)
...
While my fork lives at `https://github.com/tabilabs/tabichain`,
